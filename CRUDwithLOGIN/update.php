...
if (isset($_POST["submit"])) {
    ...
    if ($pictureArray->error === 0) {
        ...
        $sql = "UPDATE users SET fname = '$fname', lname = '$lname', email = '$email', birthdate = '$birthdate', picture = '$pictureArray->fileName' WHERE id = {$id}";
    } else {
        $sql = "UPDATE users SET fname = '$fname', lname = '$lname', email = '$email', birthdate = '$birthdate' WHERE id = {$id}";
    }
